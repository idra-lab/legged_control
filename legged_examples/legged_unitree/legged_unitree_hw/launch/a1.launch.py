#!/usr/bin/env python3
"""a1.launch.py — ROS 2 porting of a1.launch
...
This launcher:
  1. Starts ros2_control_node with the A1 URDF and hardware config YAML
...
def generate_launch_description():
    ...
    # The Unitree SDK 3.3.1 plugin is used for A1/Aliengo.
