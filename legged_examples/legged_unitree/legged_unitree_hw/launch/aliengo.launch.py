#!/usr/bin/env python3
"""aliengo.launch.py — ROS 2 porting of aliengo.launch
...
This launcher:
  1. Starts ros2_control_node with the Aliengo URDF and hardware config YAML
  2. Spawns all required controllers
  (Uses Unitree SDK 3.3.1 — same as A1)
"""
import os
...
def generate_launch_description():
    ...
    # The Unitree SDK 3.3.1 plugin is used for Aliengo.
