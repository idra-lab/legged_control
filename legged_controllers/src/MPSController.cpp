...
#include "legged_controllers/MPSController.h"
...
namespace legged {
bool MPSController::init(hardware_interface::RobotHW* robot_hw, ros::NodeHandle& controller_nh) {
  // Initialize OCS2
  std::string urdfFile;
  std::string taskFile;
...
void MPSController::starting(const ros::Time& time) {
  // Initial state
...
void MPSController::update(const ros::Time& time, const ros::Duration& period) {
...
void MPSController::updateStateEstimation(const ros::Time& time, const ros::Duration& period) {
...
void MPSController::setupLeggedInterface(const std::string& taskFile, const std::string& urdfFile, const std::string& referenceFile,
                                            bool verbose) {
  leggedInterface_ = std::make_shared<LeggedInterface>(taskFile, urdfFile, referenceFile);
  leggedInterface_->setupOptimalControlProblem(taskFile, urdfFile, referenceFile, verbose);
}

void MPSController::setupMpc() {
...
void MPSController::setupStateEstimate(const std::string& taskFile, bool verbose) {
...
PLUGINLIB_EXPORT_CLASS(legged::MPSController, controller_interface::ControllerBase)