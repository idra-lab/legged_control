...
TEST(ConfigLoading, TaskFileMatchesPythonReference) {
  ...
  // Augmented dimensions: 2 branches of 10 states + clock, 2 branches of 8 inputs + 4 hyperplane
  // variables per obstacle per branch (phiMid, phiLand, bMid, bLand).
  EXPECT_EQ(p.stateDim(), 21);
